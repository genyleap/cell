...
std::string Html::TagParams(const std::vector<std::string>& a) __cell_noexcept_expr(true)
{
    std::string params = "";
...
std::string Html::Input(const std::string& name,
                        ...
                        const std::string& value,
                        const std::vector<std::string>& extra, ss8 mode = 1) __cell_noexcept_expr(true)
{
