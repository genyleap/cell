...
// CELL_NAMESPACE_BEGIN(Cell::Modules::BuiltIn::Gui)

// enum class GuiType : Types::u8
// {
//     Qt,
//     wxWidgets,
//     Custom
...
// class __cell_export Ui
// {
// public:
//     CELL_DEFAULT_OCTORS(Ui)
//     void showWindow();

//     Types::Optional<Parisa> getRet();
