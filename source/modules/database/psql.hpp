...
#if __has_include("psqlprivate.hpp")
#   include "psqlprivate.hpp"
#else
...
public:
    ...
    /**
     * @brief Constructs a PostgreSqlDatabaseConnection object.
     *
     * @param connectionPool The connection pool for managing PostgreSQL connections.
     */
    PostgreSqlDatabaseConnection(PostgreSqlConnectionPool& connectionPool);

    /**
     * @brief Destroys the PostgreSqlDatabaseConnection object.
     */
...
private:
    ...
    PostgreSqlData           m_PostgreSqlData;
    PostgreSqlPtr            connection;         //!< Pointer to the MySQL connection object.
    PostgreSqlConnectionPool& connectionPool;    //!< Reference to the MySQL connection pool.
};
